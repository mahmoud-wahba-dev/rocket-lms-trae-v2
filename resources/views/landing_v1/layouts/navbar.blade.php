<nav class="fixed top-0 z-50 navbar rounded-box flex w-full items-center justify-between gap-2 shadow-[0px_4px_34.5px_-3px_#0000000D]">
    ...
    <div class="navbar-center max-md:hidden">
        <ul class="menu menu-horizontal p-0 font-medium">
            <li><a class="font-medium text-15px text-[#3D455D] " href="{{ route('landing.v1.index') }}">الرئيسية</a></li>
            <li><a class="font-medium text-15px text-[#3D455D] " href="{{ route('landing.v1.about') }}">من نحن</a></li>
            <li><a class="font-medium text-15px text-[#3D455D] " href="{{ route('landing.v1.courses') }}">الدورات</a></li>
            <li><a class="font-medium text-15px text-[#3D455D] " href="{{ route('landing.v1.instructors') }}">المدربين</a></li>
            <!-- <li><a class="font-medium text-15px text-[#3D455D] " href="#">المقالات</a></li> -->
            <li><a class="font-medium text-15px text-[#3D455D] " href="{{ route('landing.v1.contact') }}">تواصل معنا</a></li>
        </ul>
    </div>
    <div class="navbar-end items-center gap-4 max-xl:w-fit">
        <div class="dropdown relative inline-flex md:hidden rtl:[--placement:bottom-end]">
            ...
            <ul class="dropdown-menu dropdown-open:opacity-100 hidden min-w-60" role="menu" aria-orientation="vertical"
                ...
                <li><a class="dropdown-item font-medium text-15px text-[#3D455D]" href="{{ route('landing.v1.index') }}">الرئيسية</a></li>
                <li><a class="dropdown-item font-medium text-15px text-[#3D455D]" href="{{ route('landing.v1.about') }}">من نحن</a></li>
                <li><a class="dropdown-item font-medium text-15px text-[#3D455D]" href="{{ route('landing.v1.courses') }}">الدورات</a></li>
                <li><a class="dropdown-item font-medium text-15px text-[#3D455D]" href="{{ route('landing.v1.instructors') }}">المدربين</a></li>
                <!-- <li><a class="dropdown-item font-medium text-15px text-[#3D455D]" href="#">المقالات</a></li> -->
                <li><a class="dropdown-item font-medium text-15px text-[#3D455D]" href="{{ route('landing.v1.contact') }}">تواصل معنا</a></li>
            </ul>
        </div>
        <div class="flex items-center gap-4">
            <div class="flex items-center gap-4">
                <a href="" class="btn btn-text max-xl:px-1">
                ...
                <a href="" class="btn btn-text max-xl:px-1  ">
                    <svg width="20" height="20" viewBox="0 0 28 31" fill="none" xmlns="http://www.w3.org/2000/svg">
