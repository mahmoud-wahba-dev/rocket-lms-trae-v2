            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-20 gap-4">
                <div class="l">
                    <div>
                        ...
                        <div>
                            <nav class="tabs overflow-x-auto space-x-1 rtl:space-x-reverse p-1 rounded-10px border mb-6 border-[#CCCCCC] h-16" aria-label="Tabs"
                                role="tablist" aria-orientation="horizontal">
                                <button type="button"
                                    class="btn btn-text active-tab:bg-[#F5F8F9] h-full font-medium text-20px text-primary active-tab:text-primary hover:text-primary active hover:bg-primary/20"
